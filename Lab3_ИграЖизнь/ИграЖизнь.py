...
print("Введите размер экрана по горизонтали")
# width_count = int(input('L = '))
width_count = 50

print("Введите размер экрана по вертикали")
...
# создание экрана с заданным разрешением
screen = pg.display.set_mode(resolution)
clock = pg.time.Clock()

# генератор случайных чисел для заполнения
